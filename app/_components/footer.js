...
export const Footer = () => {
  return (
    <footer>
      <div className=' bg-gray-950/50 py-28 border-t border-gray-100/25'>
        <div className='container mx-auto space-y-28'>
          <div className='space-y-10'>
            ...
            <div>
              <a className='text-gray-500 nav-link hover:text-text' href='mailto:markphillip1800@gmail.com'>markphillip1800@gmail.com</a>
            </div>
            <div>
              <ul className='flex gap-6'>
                <li>
                  <a href='https://www.linkedin.com/in/markphillip1800/' target='_blank'>
                    <Image
                    src="/linkedin.svg"
                    width={25}
                    height={25}
